...
# channel.  Calls `[fcopy]` to pipe data from the file channel to the client
# channel for one `readBufferSize` chunk.  If this method reaches an EOF on the
# file channel, then it will yield `$session` to the next request and destroy
# itsle.f
#
